...
filename = ''.join(['TIDY/ARCHIVE/', year, '/T/ORCH0083-LIM3_', year, '0928_T_d05.nc'])
...
sss = nemo.load_field('sosaline', homedir, nemodir, filename, 'T')
...
plt.savefig(''.join(['EXP02_sss', year, '.png']), bbox_inches='tight', dpi=1200)
